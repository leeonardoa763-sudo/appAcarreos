/**
 * components/forms/FormCheckbox.js (OPTIMIZADO)
 *
 * Componente de checkbox reutilizable con label
 *
 * OPTIMIZACIONES IMPLEMENTADAS:
 * - Eliminado console.log que causa lag
 * - Añadido React.memo para evitar re-renders innecesarios
 * - useCallback para handler estable
 *
 * PROPÓSITO:
